...
public class Aims {
	...
	public static void main(String[] args) {
		...
		Book b1 = new Book("Calculus 1","maths",15.55f);
		Book b2 = new Book("Calculus 1","maths",15.55f);
		Book b3 = new Book("Algebra","maths",15.55f);
		...
		CompactDisc cd2 = new CompactDisc("Big bang", "kpop", 12.22f, null, "g rong");
		store.addMedia(cd1);
		store.addMedia(b1);
		store.addMedia(b2);
		store.addMedia(b3);
